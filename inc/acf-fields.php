...
if ( function_exists( 'acf_add_local_field_group' ) ) :
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_pricing_cards',
				'label' => 'Cartes Tarifs',
				'name' => 'pricing_cards',
				'type' => 'repeater',
				'button_label' => 'Ajouter une carte tarif',
				'sub_fields' => array(
					array(
						'key' => 'field_pricing_card_title',
						'label' => 'Titre',
						'name' => 'pricing_card_title',
						'type' => 'text',
					),
					array(
						'key' => 'field_pricing_card_price',
						'label' => 'Prix',
						'name' => 'pricing_card_price',
						'type' => 'text',
						'instructions' => 'Utilisez <del></del> pour barrer les anciens prix',
					),
					array(
						'key' => 'field_pricing_card_items',
						'label' => 'Liste des items',
						'name' => 'pricing_card_items',
						'type' => 'repeater',
						'button_label' => 'Ajouter un item',
						'sub_fields' => array(
							array(
								'key' => 'field_pricing_item',
								'label' => 'Item',
								'name' => 'pricing_item',
								'type' => 'wysiwyg',
								'toolbar' => 'basic',
